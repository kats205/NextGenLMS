...
export function AssessmentAttemptPage({ user }: AssessmentAttemptPageProps) {
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3">
                      {question.options.map((option, optIndex) => (
                        <label
                          key={option.id}
                          className={`flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer transition-all ${answers[question.id]?.includes(option.id)
